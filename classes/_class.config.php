...
class config{
    ...
    public $bonusSignupType = 'item';//тип бонуса при регистрации: item - персонаж, money - серебро
    public $bonusSignupItem = 'a_b';//счет зачисления бонуса: если тип указан "персонаж", то указать
    //a_t,b_t,c_t,d_t,e_t, если тип указан "серебро", то указать счет зачисления b-для покупок, p-для выплат
