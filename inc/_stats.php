...
<div class="stat">
	...
	<div class="line-st"><a href="/payments" style="text-decoration:none; color: blue;"><?=sprintf('%.2f',$stats_data['all_payment']); ?></a> RUB</div>
	<div class="line-st"><?=sprintf('%.2f',$stats_data['all_insert']); ?> RUB</div>
	</div>
	<div class="clr"></div>
	<div class="st-time"><img style="vertical-align:-5px; margin-right:5px;" src="/assets/style/img/clock.png" />Проекту пошел: <font color="#f77827"><?=intval(((time() - $config->SYSTEM_START_TIME) / 86400 ) +1); ?> - й</font> день</div>
</div>
<div class="stat">
